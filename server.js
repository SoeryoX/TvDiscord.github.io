...
async function startBrowser(url) {
    ...
    browser = await puppeteer.launch({
        ...
        args: [
            ...
            "--enable-widevine",
            "--disable-gpu", // :no_entry: Disables hardware acceleration (Forces software rendering)
...
// :small_blue_diamond: API: Press a key in the open browser
...
app.listen(PORT, async () => {
    ...
    await startBrowser("https://paimm13.github.io/RemoteTV.github.io/");
});